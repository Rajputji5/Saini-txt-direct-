...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/StudyXashish1")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/StudyXashish"),
            InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/StudyXashish1"),
        ],
    ]
)
